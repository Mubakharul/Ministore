...
function Mobile() {
  ...
  <h1 className='text-center text-xl md:text-2xl font-bold'>Mobile Products</h1>
  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-items-center text-[#272727]'>
    <div>
    <img src="iphonesell.png" alt="" className="w-full h-auto" />
    ...
    <div>
    <img src="iphone11.png" alt="" className="w-full h-auto" />
    <div className="flex flex-col lg:flex-row justify-between uppercase ">
      <p>Iphone 11</p>
    ...
    <div>
    <img src="iphone8.png" alt="" className="w-full h-auto" />
    <div className="flex flex-col lg:flex-row justify-between uppercase ">
      <p>Iphone 8</p>
    ...
    <div>
    <img src="iphone13.png" alt="" className="w-full h-auto" />
    <div className="flex flex-col lg:flex-row justify-between uppercase ">
      <p>Iphone 13</p>
