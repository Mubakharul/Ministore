...
function Watches() {
  ...
  <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 justify-items-center text-[#272727]'>
    <div>
    <img src="pinkwatach.png" alt="" className="w-full h-auto" />
    ...
    <div>
    <img src="Heavyw.png" alt="" className="w-full h-auto" />
    <div className="flex flex-col lg:flex-row justify-between uppercase ">
      <p>হেভি ওয়াচ</p>
    ...
    <div>
    <img src="spott.png" alt="" className="w-full h-auto" />
    <div className="flex flex-col lg:flex-row justify-between uppercase ">
      <p>স্পটেড ওয়াচ</p>
    ...
    <div>
    <img src="Black.png" alt="" className="w-full h-auto" />
    <div className="flex flex-col lg:flex-row justify-between uppercase ">
      <p>ব্ল্যাক ওয়াচ</p>
